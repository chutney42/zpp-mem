...
class BatchNormalization(Layer):
    ...
    def build_backward(self, error, gather_stats=True):
        ...
        with tf.variable_scope(self.scope, reuse=True):
            number_of_channels = int(reduce(lambda x, y: x * y, input_vec.shape[1:]))  # Number of features in input_vec
            ...
            output_error = dz_norm * std_inv + (dvar * 2 * layer_input_zeroed / number_of_channels) + dmu / number_of_channels
