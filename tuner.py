...
if __name__ == '__main__':
    ...
    # vgg_16_BP_tuner = cmd_generator([sgen("name", ["exp_cifar_vgg_bp", "exp_cifar_vgg_fa"])
    vgg_16_BP_tuner = cmd_generator([sgen("name", ["exp_cifar_vgg_dfa", "exp_cifar_vgg_memdfa"])
                                     # sgen("type", ["BP", "DFA"]),
