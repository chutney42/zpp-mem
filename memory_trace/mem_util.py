...
def _print_parsed_timeline(timeline, gpu_only=False, ignore_less_than_bytes=0, file="foo"):
...
def print_plot(run_metadata, gpu_only=False, ignore_less_than_bytes=0, filename="foo", total_mem=0):
...
def print_memory_timeline(run_metadata, device=None, file="foo"):
    ...
    _print_parsed_timeline(parsed_timeline, file=file)
